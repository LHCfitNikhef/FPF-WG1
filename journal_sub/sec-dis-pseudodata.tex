...
\end{align}
 ...
 In the projections presented here, when interpreting the LHC neutrino structure
...
%
With this assumption, we will show that Run 3 measurements will not be sufficient to impact PDF fits. Instead, Run 3 measurements could be used to calibrate incoming neutrino fluxes, effectively reducing the large uncertainties by the time FPF data is collected in the future. The expected reduction of FPF neutrino flux uncertainties further justifies our choice to take the neutrino flux as known.
%
