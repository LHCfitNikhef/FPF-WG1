...
\caption{\small For each of the far-forward LHC neutrino experiments considered,
  ...
  %
  In the case of FLArE, we consider projections for fiducial volumes corresponding to both 10 and 100 tonne detectors, which we denote for the two detectors as as FLArE(*).
