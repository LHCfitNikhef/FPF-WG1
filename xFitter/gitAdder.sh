#!/bin/bash
declare -a detectors=("FASERv" "FASERv2" "FLArE10" "FLArE100" "AdvSND")
...
for pdf in ${pdfs[@]}; do
    ...
    if [[ ${pdf}=="PDF4LHC21" ]]; then
        declare -a statOnlyDirs=("AdvSND" "FLArE100" "FLArE10" "FASERv" "FASERv2" "FASERv2_nochargediscrimination" "FASERv2_inclusive" "FASERv2_inclusive_nochargediscrimination" "FASERv2_charm" "FASERv2_charm_nochargediscrimination")
        ...
        declare -a statOnlyDirs=("AdvSND" "FLArE100" "FLArE10" "FASERv2" "FASERv2_nochargediscrimination" "FASERv2_inclusive" "FASERv2_inclusive_nochargediscrimination" "FASERv2_charm" "FASERv2_charm_nochargediscrimination")
        declare -a systDirs=()
        declare -a systVar05Dirs=("FASERv2" "FASERv2_nochargediscrimination" "FASERv2_inclusive" "FASERv2_inclusive_nochargediscrimination" "FASERv2_charm" "FASERv2_charm_nochargediscrimination")
        declare -a systVar05ElDirs=("FASERv2" "FASERv2_nochargediscrimination" "FASERv2_inclusive" "FASERv2_inclusive_nochargediscrimination" "FASERv2_charm" "FASERv2_charm_nochargediscrimination")
    fi
