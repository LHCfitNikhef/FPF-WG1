...
xfitter-draw ${PLOTOPTS} output:"Baseline (BL)" profile:../../fred05fcorr05/${DETSIMPLE}/output:"BL+${DETECTOR}, no flux FX" profile:output:"Run3 flux constr."
