...
Q^2 \ge 2~{\rm GeV}^2\quad{\rm and} W^2 \ge 12.5~{\rm GeV}^2 \, .
\ee
  %
...
the assignbment of each event to a given bin of $x$, $Q^$, and $E_\mu$ introducing a systematic
error in the event yields and hence in the measurement of the double-differemtial
