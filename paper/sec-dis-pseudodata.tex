...
\begin{figure}[!ht]
	\centering
	\includegraphics[width=0.8\textwidth]{plots/percentage_error_El.pdf}
	\caption{Estimate of the systematic uncertainties at FASER$\nu$2 coming from the final-state 
		lepton energy $E_\ell$ for the inclusive and charm productions. The different markers
		represent the charge of the incoming neutrino.
	}
	\label{fig:percentage_error_elepton}
\end{figure}
%-----------------------------------------------------------------------
