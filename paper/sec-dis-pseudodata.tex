...
This ensures that the generated pseudo-data is consistent with the prior PDF
 ...
 %
 Here we consider two scenarios for the systematic errors: conservative,  $f_{\rm red}=1$, where
 no improvement as compared to current projected performance takes place, and  $f_{\rm red}=0.5$, a factor
 two improvement for all relevant sources of systematics.
 %
