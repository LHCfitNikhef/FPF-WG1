...
\begin{table}[!t]
  ...
  \midrule
  $\chi^2/n_{\rm dat}$ &  \multirow{4}{*}{Global}  & 1.17  &  1.16   & 1.15   \\
  ...
  & DIS charged-current                     &   0.90  &   0.94    &  0.90    \\
  & Drell--Yan (inclusive and one-jet)      &  1.76   &   1.83    &   1.83   \\
  & Top-quark pair production               &  1.23   &   1.22    &  1.25     \\
  & Single-top production                   &  0.36    &   0.36   &   0.37    \\
  & Inclusive jet production                &  0.96    &  0.96      &   0.94    \\
  & Dijet production                        &  2.03     &    2.01    &   2.00    \\
  & Direct photon production                 &  0.74   &   0.73     &    0.73   \\
  & FPF (total)                 &  1.30  / 0.92  &   1.19     &   0.89    \\
  \bottomrule
\end{tabularx}
\vspace{0.2cm}
