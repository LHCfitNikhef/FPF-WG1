...
to be  hosted at the proposed
 ...
 experiments in a kinematic region in $x$ and $Q^2$ comparable to that
 covered by the upcoming
 Electron-Ion Collider (EIC).
 %
 This sensitivity is found to be the largest for  strangeness as well as for
 the up and down valence quark PDFs, and lead to improved theoretical
 predictions for key scattering processes at the HL-LHC.
%
