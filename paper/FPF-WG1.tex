...
Including these DIS projections into global (n)PDF analyses, specifically PDF4LHC21, NNPDF4.0,
 ...
 %
 We demonstrate that LHC neutrino data enables improved theoretical
 predictions for core processes at the HL-LHC, such as Higgs and weak gauge (di)boson production.
%
 Our analysis highlights how exploiting the LHC neutrino beam effectively
provides CERN with a new ``Neutrino-Ion Collider''.
